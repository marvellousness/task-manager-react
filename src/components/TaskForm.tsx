...
export function TaskForm({onAddTask,}: {
  ...
  const handleSubmit = () => {
    if (title.trim()) {
      onAddTask(title.trim(), priority, description.trim() || undefined);
      setTitle("");
      setPriority("medium");
          ...
          <>
            ...
            <div className="mt-3">
              <textarea
                ...
                className="w-full px-3 py-2 rounded-lg border-2 border-gray-100 resize-none outline-none placeholder:text-gray-400"
                rows={3}
              />
            </div>
          </>
